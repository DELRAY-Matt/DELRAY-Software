...
UM.Dialog
{
    ...
    Item
    {
        ...
        Label
        {
            ...
            text: catalog.i18nc("@text:window", "Blade sends anonymous data to BigRep in order to improve the print quality and user experience. Below is an example of all the data that is sent.")
    ...
    Column
    {
        ...
        {
            id: allowSendButton
            text: catalog.i18nc("@text:window", "Allow sending these data to BigRep and help us improve Blade")
            exclusiveGroup: group
            onClicked:
            {
                baseDialog.allowSendData = checked;
