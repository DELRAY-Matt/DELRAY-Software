...
Item
{
    ...
    property alias bigrep_bug: bigrepBugAction;
    property alias about: aboutAction;
    property alias bigrep_faq: bigrepFAQAction;
    ...
    Action
    {
        ...
        text: catalog.i18nc("@action:inmenu","Configure BigRep Blade...");
        iconName: "configure";
    }
    ...
    {
        id: bigrepFAQAction;
        text: catalog.i18nc("@action:inmenu menubar:help","FAQ...");
        iconName: "help-faq";
    }
