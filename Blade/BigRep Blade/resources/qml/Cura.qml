...
UM.MainWindow
{
    ...
    title: catalog.i18nc("@title:window","BigRep Blade");
...
//                MenuItem { action: Cura.Actions.showProfileFolder; }
                MenuItem { action: Cura.Actions.bigrep_faq; }
//                MenuItem { action: Cura.Actions.documentation; }
//                MenuItem { action: Cura.Actions.reportBug; }
                MenuItem { action: Cura.Actions.bigrep_bug; }
//                MenuSeparator { }
    ...
    Connections
    {
        target: Cura.Actions.bigrep_faq
        onTriggered: {
            var url = "../Documentation/FAQ.html"
    ...
    Connections
    {
        target: Cura.Actions.bigrep_bug
        onTriggered: {
            var url = "https://support.bigrep.com/ticket/"
            Qt.openUrlExternally(url)
        }
    }
