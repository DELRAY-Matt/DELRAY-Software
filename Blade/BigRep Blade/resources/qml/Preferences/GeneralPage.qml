    ...
    ScrollView
    {
        ...
        Column
        {
            ...
            UM.TooltipArea {
                width: childrenRect.width;
                height: childrenRect.height;
                text: catalog.i18nc("@info:tooltip", "Should the default zoom behavior of BigRep Blade be inverted?")
            ...
            UM.TooltipArea
            {
                visible: false // pluginExistsAndEnabled("UpdateChecker")
                width: childrenRect.width
            ...
            UM.TooltipArea
            {
                visible: pluginExistsAndEnabled("DataCollector")
                width: childrenRect.width
                height: visible ? childrenRect.height : 0
                text: catalog.i18nc("@info:tooltip","Should anonymous data about your print be sent to BigRep? Note, no models, IP addresses or other personally identifiable information is sent or stored.")
