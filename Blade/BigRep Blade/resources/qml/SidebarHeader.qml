                        ...
                        Item
                        {
                            ...
                            Item
                            {
                                ...
                                Label
                                {
                                    ...
                                    anchors.centerIn: parent
                                    text: index; // BigRep: start numbering by 0
                                    color: buttonColor(index)
        ...
        Item
        {
			...
			Label {
                ...
                MouseArea {
                    ...
                    hoverEnabled: true				
                    onEntered: {
                        var content = catalog.i18nc("@tooltip", "Material(s) not compatible with selected extruder(s) or selected extruder/nozzle sizes combination.");
                        base.showTooltip(
                            materialInfoRow,
